...
class AlipayF2F {
    ...
    public function send()
    {
        ...
        if (!isset($response[$resKey])) throw new \Exception('Request from Alipay failed');
    ...
    public function getQrCodeUrl()
    {
        ...
        if (!isset($response['qr_code'])) throw new \Exception('Failed to obtain payment QR code');
